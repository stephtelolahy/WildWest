...
class CatBalouTests: XCTestCase {
    ...
    func test_CanPlayCatBalouToDiscardOtherInPlay() throws {
        ...
        let mockCard1 = MockCardProtocol()
            ...
            .identified(by: "c1")
            .type(is: .brown)
            .abilities(are: "discardAnyInPlay")
        let mockPlayer1 = MockPlayerProtocol()
            .withDefault()
            .identified(by: "p1")
            .holding(mockCard1)
        ...
        // Assert
        XCTAssertEqual(moves, [GMove("discardAnyInPlay", actor: "p1", card: .hand("c1"), args: [.target: ["p2"], .requiredInPlay: ["c2"]])])
        XCTAssertEqual(events, [.play(player: "p1", card: "c1"),
    ...
    func test_CanPlayCatBalouToDiscardSelfInPlay() throws {
        ...
        // Assert
        XCTAssertEqual(moves, [GMove("discardAnyInPlay", actor: "p1", card: .hand("c1"), args: [.target: ["p1"], .requiredInPlay: ["c2"]])])
        XCTAssertEqual(events, [.play(player: "p1", card: "c1"),
