...
class GatlingTests: XCTestCase {
    ...
    func test_CanPlayGatling_IfOwnCard() throws {
        ...
        XCTAssertEqual(events, [.play(player: "p1", card: "c1"),
                                .addHit(name: "gatling", player: "p2", abilities: ["looseHealth"], cancelable: 1, offender: "p1"),
                                .addHit(name: "gatling", player: "p3", abilities: ["looseHealth"], cancelable: 1, offender: "p1")])
    }
}
