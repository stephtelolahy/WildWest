...
class ResourcesTests_Cards: XCTestCase {
    ...
    func test_Bang() {
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "A" && $0.suit == .spades })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "2" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "3" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "4" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "5" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "6" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "7" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "8" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "9" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "10" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "J" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "Q" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "K" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "A" && $0.suit == .diamonds })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "2" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "3" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "4" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "5" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "6" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "7" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "8" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "9" && $0.suit == .clubs })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "Q" && $0.suit == .hearts })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "K" && $0.suit == .hearts })
        XCTAssertTrue(cards.contains { $0.name == .bang && $0.value == "A" && $0.suit == .hearts })
    }
